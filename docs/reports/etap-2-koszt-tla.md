...
Wynik wskazuje potrzebę późniejszego profilowania i ograniczenia kosztu CPU. Właściciel zdecydował odłożyć optymalizację; znany koszt nie blokuje odbioru funkcjonalnego odczytów na M4 Pro. Pomiar nie obejmuje bezpośrednio poboru energii w watach ani czasu pracy na baterii. Surowy CSV znajduje się tylko w katalogu tymczasowym maszyny testowej i nie jest dodawany do repozytorium.
