...
7. Okno, pasek menu, Dock i autostart F1-06 - rozpoczęty; model ustawień, koordynator cyklu życia, ikona, panel i opcjonalne CPU/RAM/W są gotowe. Dock, autostart i tryb uruchomienia pozostają.
